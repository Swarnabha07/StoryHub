...
const Navbar = ({
  ...
  if (session) {
    return (
      <>
        <nav className="bg-[#FFFDF9] flex justify-between items-center px-8 py-4">
          <ul className="flex justify-start items-center w-1/3 gap-16">
            <li>
              <svg
                onClick={() => setIsSidebarOpen((prev) => !prev)}
                className="cursor-pointer fill-[#9c9c9c] hover:fill-[#000000] transition-colors duration-100"
            ...
            <li>
              <div className="logo flex justify-center items-center gap-1">
                ...
                <Link href={`/`}>
                  <span
                    className={`text-[#1F2937] text-3xl ${lora.className} cursor-pointer`}
                  >
                    StoryHub
                  </span>
                </Link>
          ...
          <ul className="flex justify-end items-center w-1/3 gap-16">
            <li>
  ...
  return (
    <nav className="bg-[#FFFDF9] flex justify-between items-center px-28 py-6">
      <div className="logo flex justify-center items-center gap-1">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          height="40px"
        ...
        <Link href={`/`}>
          <span
            className={`text-[#1F2937] text-4xl ${lora.className} cursor-pointer`}
          >
            StoryHub
          </span>
        </Link>
      ...
      <ul className="flex gap-20">
        <Link href={`/about`}>
          <li
            className={`text-xl cursor-pointer hover:underline text-[#1F2937] ${
