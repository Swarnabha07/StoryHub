...
export default function InAppPreferences() {
  const preferenceItems = [
    {
      ...
      label: "Comments",
      description:
        "Get notified through in-app toasts when someone comments on your post",
    },
    {
      key: "replies",
      label: "Replies",
      description:
        "Get notified through in-app toasts when someone replies to your comment",
    },
    {
      key: "follows",
      label: "Follows",
      description:
        "Get notified through in-app toasts when someone follows you",
    },
    {
      key: "likes",
      label: "Likes",
      description:
        "Get notified through in-app toasts when someone likes your post or comment",
    },
  ];
  ...
  return (
    <div className="bg-[#FFFDF9] w-full md:px-4 py-10 space-y-6 border-b border-[#d3d3d3]">
      <h2 className="text-lg md:text-2xl font-bold">Popup Notification Preferences</h2>
